...
YELLOW = 'yellow'
RED = 'red'
crash_sound = pygame.mixer.Sound("loselife.wav")
pad_sound = pygame.mixer.Sound("pad.wav")
adv_sound = pygame.mixer.Sound("advancement.wav")
...
class Grid:
    ...
    def next_grid(self):
        if self.level > 4:
            return
        pygame.mixer.music.load('advancement.wav')
        self.level += 1
        self.grid = self.get_grid()
